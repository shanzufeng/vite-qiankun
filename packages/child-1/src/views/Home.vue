...
<!--  <div>当前位置{{ x }}, {{ y }}</div>-->
<!--  <el-button @click="changeRouter">切换到单独的hmtl页面</el-button>-->
<!--  <zujian />-->
<!--</template>-->
...
<template>
  <div class="layout-container">
    <h1>使用说明</h1>
    <p>
      为什么文档是写在系统内，一方面是因为偷懒，另一方面是因为我坚信，如果我用着不爽，那么大家用着也不会爽，所以文档部分就暂时放置于此了
    </p>
    <article>
      <h2>简介</h2>
      <p>
        vue-admin-box是一个开源的中后台管理项目，主要技术栈为vue3全家桶，包括了：vue3(vue-next)、vite、element-plus、vue-router、vuex等众多中后台项目常用技术。
      </p>
      <ol>
      ...
      <h2>关于crud的优化</h2>
      <p>
        简单来说，你直接复制业务表格的文件夹，改个名，换个接口，调一下里面的细节，就可以直接使用了
      </p>
      <p>
        业务表格，这是本开源项目最核心的理念，我基于日常开发过程中的情景，封装了一个核心的<b>弹窗组件</b>及一个<b>table组件</b>。
      </p>
      <h3>弹窗组件</h3>
